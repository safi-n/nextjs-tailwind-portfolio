...
const ExperinceCode = () => {
  return (
    <div className='w-[60vw] mx-auto text-white'>
      ...
      <div className="flex experience-content justify-between gap-8 mt-6">
        <p className='w-[30rem]'>An experienced multimedia designer with 8 years in the field, who has also developed frontend skills with 3 years of experience. Has a background in creating various multimedia designs and has expertise in combining design and technology to build engaging user experiences.</p>
